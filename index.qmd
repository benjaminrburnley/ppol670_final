...
=======
  select(-district_22) %>%
>>>>>>> 76910f410d984c4230111ef9cf11d811dfd25fa7
...
### attempted further hyperparameter tuning but best results were from
### original tune grid
...
bind_cols(
  `actual` = data_test$redrawn,
  predict(rf_final_fit, new_data = data_test, type = "prob")) %>%
  roc_curve(truth = actual, estimate = .pred_FALSE) %>%
  autoplot()
>>>>>>> 76910f410d984c4230111ef9cf11d811dfd25fa7
